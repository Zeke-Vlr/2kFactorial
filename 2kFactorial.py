...
#^^^ the all low value cases. Uncomment out the print below "tm" to varify that
...
filename = "test2"  #without the .txt file extension, just the saved name
test = readfile(filename)

#*********************************************************
         #Do you want to save the 2k factorial results to a .txt file?
savefile = 'y'        #Use 'y' to save a file
filewrite = 'test1'   #If you do not change the file name it will append the next results to the same file
                      #I would recommend naming this file the type of test/parameters being explored
#*********************************************************
k = int(math.log2(len(test))) # the k value is calulated based on the number of test results
tm = ff2n(k) 
# print(tm)
...
#[-1,-1,-1]   #The patern is the the first column alternates by ones, 
